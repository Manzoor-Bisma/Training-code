...
function OtpVerify() {
    ...
    const resetPass = (e) => {
        ...
        if (data.otp) {
            const otpData = fetch(`/students/change-password`, {
                method: 'POST',
                headers: {
        ...
        */}
            <div className='container'>
                ...
                { otpForm ? <form autoComplete='off' id="otpform" method='post'>
                        ...
                        {/* <input type="text" className='form-control' placeholder="Otp" hidden={otpHide} disabled={disbl} name="OTP" onChange={(e) => { setOtp(e.target.value) }} style={{marginLeft:'5px'}} />
                        ...
                        {/* <button className='btn btn-primary' onClick={getOTP} disabled={resDis} hidden={otpHide}> Resend Otp </button> */}
                  ...
                  :  <form autoComplete='off' id="otpform" method='post'>
                        ...
                        <div>
                            {/* <Link to='/other'> <button type='button' className='btn btn-primary' hidden={emailHide} onClick={getOTP}> send otp </button> </Link> */}
                            {/* nbsp; */}
                            {/* <Link to='/'> <button type='button' className='btn btn-danger' style={{marginBottom:'-7rem', marginLeft: '12rem' }}>  back </button></Link> */}
                        </div>
